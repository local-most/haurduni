                    ...
                    <div class="carousel-item active">
                        <div class="container-fluid ">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="img-box">
                                        <img src="{{ asset('timups/images/slider-img.png') }}" alt="">
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="col-md-6 ">
                    <div class="box">
                        <a href="">
                            <div class="img-box">
                                <img src="{{ asset('timups/images/w1.png') }}" alt="">
                            </div>
                            <div class="detail-box">
                                <h6>
                                    Smartwatch
                ...
                <div class="col-sm-6 col-xl-3">
                    <div class="box">
                        <a href="">
                            <div class="img-box">
                                <img src="{{ asset('timups/images/w2.png') }}" alt="">
                            </div>
                            <div class="detail-box">
                                <h6>
                                    Smartwatch
                ...
                <div class="col-sm-6 col-xl-3">
                    <div class="box">
                        <a href="">
                            <div class="img-box">
                                <img src="{{ asset('timups/images/w3.png') }}" alt="">
                            </div>
                            <div class="detail-box">
                                <h6>
                                    Smartwatch
                ...
                <div class="col-sm-6 col-xl-3">
                    <div class="box">
                        <a href="">
                            <div class="img-box">
                                <img src="{{ asset('timups/images/w4.png') }}" alt="">
                            </div>
                            <div class="detail-box">
                                <h6>
                                    Smartwatch
                ...
                <div class="col-sm-6 col-xl-3">
                    <div class="box">
                        <a href="">
                            <div class="img-box">
                                <img src="{{ asset('timups/images/w5.png') }}" alt="">
                            </div>
                            <div class="detail-box">
                                <h6>
                                    Smartwatch
                ...
                <div class="col-sm-6  col-xl-3">
                    <div class="box">
                        <a href="">
                            <div class="img-box">
                                <img src="{{ asset('timups/images/w6.png') }}" alt="">
                            </div>
                            <div class="detail-box">
                                <h6>
                                    Smartwatch
        ...
        <div class="container  ">
            <div class="row">
                <div class="col-md-6 col-lg-5 ">
                    <div class="img-box">
                        <img src="{{ asset('timups/images/about-img.png') }}" alt="">
                    </div>
                </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-6 col-lg-3">
                    <div class="box">
                        <div class="img-box">
                            <img src="{{ asset('timups/images/f1.png') }}" alt="">
                        </div>
                        <div class="detail-box">
                            <h5>
                                Fitness Tracking
                ...
                <div class="col-sm-6 col-lg-3">
                    <div class="box">
                        <div class="img-box">
                            <img src="{{ asset('timups/images/f2.png') }}" alt="">
                        </div>
                        <div class="detail-box">
                            <h5>
                ...
                <div class="col-sm-6 col-lg-3">
                    <div class="box">
                        <div class="img-box">
                            <img src="{{ asset('timups/images/f3.png') }}" alt="">
                        </div>
                        <div class="detail-box">
                            <h5>
                                Messages
                ...
                <div class="col-sm-6 col-lg-3">
                    <div class="box">
                        <div class="img-box">
                            <img src="{{ asset('timups/images/f4.png') }}" alt="">
                        </div>
                        <div class="detail-box">
                            <h5>
                                Bluetooth
