		...
		<div class="card">
			<div class="card-header">
				<div class="float-right">
					<a href="{{ route('admin.wilayah.create') }}" class="btn btn-primary btn-sm">Tambah Data</a>
				</div>
			</div>
			<div class="card-body">
				@if( session('msg') )
					...
					<table id="table" class="table table-bordered table-hover table-sm" width="100%">
						<tfoot id="search">
							<tr>
								...
								<th class="text-center">Standar Ongkir</th>
							</tr>
						</tfoot>
						<thead>
						...
						<tbody>
							...
							<tr>
								...
								<td class="text-center" width="150px">
									<a href="{{ route('admin.wilayah.edit', $row->id) }}" class="btn btn-success btn-sm mt-1 mb-1"><i class="fas fa-edit"></i></a>
